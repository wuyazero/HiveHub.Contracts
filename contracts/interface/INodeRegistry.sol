...
interface INodeRegistry is IERC721 {
    ...
    function updateNode(uint256 tokenId, string memory tokenURI) external;
    ...
    event NodeRegistered(uint256 tokenId, string tokenURI, string nodeEntry, address ownerAddr);
